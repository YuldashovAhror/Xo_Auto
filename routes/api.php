...
Route::get('/service/{slug}', [FrontServiceController::class, 'show']);
Route::get('/servicesingle/{slug}', [SericeSingleController::class, 'show']);
Route::get('/servicesection/{slug}', [ServiceSectionController::class, 'show']);
