        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header pb-0">
                    <h5>Create carriers</h5>
                </div>
                <form action="{{ route('dashboard.carriers.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            @foreach ($carriers as $key => $carrier)
                                <tr>
                                    <th scope="row">{{ ++$key }}</th>
                                    <td><img src="{{ $carrier->photo }}" alt=""
                                            style="height: 100px; width: 100px"></td>
                                    <td>{{ $carrier->name }}</td>
                                    <td class="text-center">
                                        <button class="btn btn-xs btn-success" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $carrier->id }}Edit"><i
                                                class="bx bx-pencil"></i>Изменить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $carrier->id }}Edit"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('dashboard.carriers.update', $carrier) }}"
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col mb-12">
                                                                        <label class="form-label">Discription</label>
                                                                        <textarea class="ckeditor" name="discription" id="exampleFormControlTextarea4" rows="3">{{ $carrier->discription }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card-footer text-end">
                                        ...
                                        <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $carrier->id }}"><i
                                                class="bx bx-trash"></i>Удалить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $carrier->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form
                                                            action="{{ route('dashboard.carriers.destroy', $carrier->id) }}"
                                                            method="post">
                                                            @csrf
                                                            {{ method_field('delete') }}
