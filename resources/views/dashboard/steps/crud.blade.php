    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <form action="{{ route('dashboard.step.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-xs btn-success" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $step->id }}Edit"><i
                                                class="bx bx-pencil"></i>Change</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $step->id }}Edit"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('dashboard.step.update', $step) }}"
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col mb-12">
                                                                        <label class="form-label">Discription</label>
                                                                        <textarea class="ckeditor" name="discription" id="exampleFormControlTextarea4" rows="3">{{ $step->discription }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card-footer text-end">
                                        ...
                                        <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $step->id }}"><i
                                                class="bx bx-trash"></i>Delete</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $step->id }}"
