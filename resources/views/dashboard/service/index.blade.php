                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($services as $service)
                            <tr>
                                ...
                                <td>{{ $service->name }}</td>
                                <td>{{ $service->title }}</td>
                                <td class="text-center"><a href="{{ route('dashboard.servicesingle.index', $service) }}"><button class="btn btn-primary">+</button></a></td>
                                <td class="text-center"><a href="{{ route('dashboard.servicesections.index', $service) }}"><button class="btn btn-primary">+</button></a></td>
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $service->id }}"><i class="bx bx-trash"></i>Удалить</button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="{{ route('dashboard.service.destroy', $service) }}" method="post">
                                                        @csrf
                                                        {{ method_field('delete') }}
