        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header pb-0">
                    <h5>Create Home Video</h5>
                </div>
                <form action="{{ route('dashboard.homevideo.update', $video) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
                    <div class="card-body">
                        <div class="row">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form
                                                            action="{{ route('dashboard.brend.destroy', $brend->id) }}"
                                                            method="post">
                                                            @csrf
                                                            {{ method_field('delete') }}
