                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @foreach($blogs as $blog)
                            <tr>
                                <th scope="row">{{ $k }}</th>
                                <td><img src="{{ $blog->photo }}" alt="" style="height: 100px; width: 200px"></td>
                                <td>{{ $blog->name }}</td>
                                @if ($blog->second_photo != null)
                                <td><img src="{{ $blog->second_photo }}" alt="" style="height: 100px; width: 200px"></td>
                                @endif
                                @if ($blog->second_photo == null)
                                <td><h3>Null</h3></td>
                                @endif
                                ...
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $blog->id }}"><i class="bx bx-trash"></i>Удалить</button>
